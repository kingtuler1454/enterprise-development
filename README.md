...
14. «Таксопарк»
Исходные данные:
Таксопарк хранит информацию о
 1. водителях (ФИО, паспорт, адрес, телефон), 
 2. автомобилях (гос.номер, модель, цвет, …), 
 3. пользователях сервиса (телефон, ФИО)  
 4. поездках (пункты отправления и назначения, дата поездки, время движения, стоимость, назначенное такси). 
